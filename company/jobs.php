					...
					<div class="card-body">
						...
						<table class="table table-bordered table-condensed table-hover">
							...
							<tbody>
								<?php
								$i = 1;
								$jobs =  $conn->query("SELECT c.*,u.name from careers c inner join users u on u.id = c.user_id where user_id = " . $_SESSION['login_id'] . " order by id desc");
								...
								?>
									<tr>
										...
										<td class="">
											<p><b><?php echo empty($row['confirmed_at']) ? '<span class="text-warning">Pending</span>' : '<span class="text-success">Posted</span>'; ?></b></p>
