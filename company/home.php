                                ...
                                <div class="card-body bg-primary">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            ...
                                            WHERE careers.company = '$_SESSION[login_company]'  AND applicants.career_id is NOT NULL
                                            ; ");
                                            echo $q->num_rows;
                            ...
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM careers WHERE user_id = " . $_SESSION['login_id'])->num_rows; ?>
                                        </b></h4>
                                        <p><b>Posted jobs</b></p>
                                    </div>
                                </div>
